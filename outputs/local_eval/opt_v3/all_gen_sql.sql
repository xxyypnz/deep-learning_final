...
DROP TABLE IF EXISTS r106_t CASCADE;
CREATE TABLE r106_t (a int);
INSERT INTO r106_t VALUES (1),(2);
SELECT count(*) FROM r106_t GROUP BY GROUPING SETS (());
DROP TABLE IF EXISTS r106_t CASCADE;

-- ===== Test Case 23 (commit 106) =====
DROP TABLE IF EXISTS r106_t2 CASCADE;
CREATE TABLE r106_t2 (a int, b int);
INSERT INTO r106_t2 VALUES (1,1),(2,2);
SELECT a, count(*) FROM r106_t2 GROUP BY ROLLUP(a, ());
DROP TABLE IF EXISTS r106_t2 CASCADE;
...
DROP TABLE IF EXISTS r118_insert CASCADE;
CREATE TABLE r118_insert (id int);
CREATE RULE "_RETURN" AS ON INSERT TO r118_insert DO ALSO SELECT 1;
DROP TABLE IF EXISTS r118_insert CASCADE;

-- ===== Test Case 62 (commit 118) =====
DROP TABLE IF EXISTS r118_update CASCADE;
CREATE TABLE r118_update (id int);
CREATE RULE "_RETURN" AS ON UPDATE TO r118_update DO ALSO SELECT 1;
DROP TABLE IF EXISTS r118_update CASCADE;

-- ===== Test Case 63 (commit 118) =====
DROP TABLE IF EXISTS r118_delete CASCADE;
CREATE TABLE r118_delete (id int);
CREATE RULE "_RETURN" AS ON DELETE TO r118_delete DO ALSO SELECT 1;
DROP TABLE IF EXISTS r118_delete CASCADE;
...
DROP VIEW IF EXISTS rw120_v CASCADE;
DROP TABLE IF EXISTS rw120_base CASCADE;
CREATE TABLE rw120_base (a int DEFAULT 1, b int DEFAULT 2);
CREATE VIEW rw120_v AS SELECT a,b FROM rw120_base;
CREATE RULE rw120_also_select AS ON INSERT TO rw120_v DO ALSO SELECT * FROM (VALUES (DEFAULT, DEFAULT), (3, DEFAULT)) AS x(a,b);
INSERT INTO rw120_v VALUES (DEFAULT, DEFAULT), (4, DEFAULT);
DROP VIEW IF EXISTS rw120_v CASCADE;
DROP TABLE IF EXISTS rw120_base CASCADE;

-- ===== Test Case 71 (commit 120) =====
DROP VIEW IF EXISTS rw120_v2 CASCADE;
DROP TABLE IF EXISTS rw120_base2 CASCADE;
DROP TABLE IF EXISTS rw120_log2 CASCADE;
CREATE TABLE rw120_base2 (a int DEFAULT 1, dropped int DEFAULT 99, b int DEFAULT 2);
ALTER TABLE rw120_base2 DROP COLUMN dropped;
CREATE TABLE rw120_log2 (a int, b int);
CREATE VIEW rw120_v2 AS SELECT a,b FROM rw120_base2;
CREATE RULE rw120_also2 AS ON INSERT TO rw120_v2 DO ALSO INSERT INTO rw120_log2 VALUES (DEFAULT, DEFAULT);
INSERT INTO rw120_v2 VALUES (DEFAULT, DEFAULT), (5, DEFAULT);
DROP VIEW IF EXISTS rw120_v2 CASCADE;
DROP TABLE IF EXISTS rw120_base2 CASCADE;
DROP TABLE IF EXISTS rw120_log2 CASCADE;
