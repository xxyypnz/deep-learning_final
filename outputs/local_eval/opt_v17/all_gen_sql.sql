...
CHECKPOINT;
\! /bin/sh -c "echo \"restore_command = '/bin/false'\" >> /workspaces/deep-learning_final/outputs/local_eval/opt_v17/coverage_workspace/data/postgresql.conf; touch /workspaces/deep-learning_final/outputs/local_eval/opt_v17/coverage_workspace/data/recovery.signal; /workspaces/deep-learning_final/postgresql-13.23/install_coverage/bin/pg_ctl -D /workspaces/deep-learning_final/outputs/local_eval/opt_v17/coverage_workspace/data stop -m fast; /workspaces/deep-learning_final/postgresql-13.23/install_coverage/bin/pg_ctl -D /workspaces/deep-learning_final/outputs/local_eval/opt_v17/coverage_workspace/data -l /workspaces/deep-learning_final/outputs/local_eval/opt_v17/coverage_workspace/server.log -o '-k /tmp/pgcov-55432 -p 55432' start" >/tmp/startupxlog_144_restart_opt_v17.log 2>&1
\connect regression
SELECT pg_is_in_recovery();
SELECT pg_sleep(1.5);
\connect regression
