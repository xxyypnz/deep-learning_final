...
-- ===== Test Case 14 (commit 102) =====
SELECT 1;

-- ===== Test Case 15 (commit 103) =====
SELECT 1;
...
DROP VIEW IF EXISTS ret118_v CASCADE;
DROP TABLE IF EXISTS ret118_t CASCADE;
CREATE TABLE ret118_t (id int);
CREATE VIEW ret118_v AS SELECT * FROM ret118_t;
CREATE OR REPLACE RULE "_RETURN" AS ON UPDATE TO ret118_v DO INSTEAD NOTHING;
DROP VIEW IF EXISTS ret118_v CASCADE;
DROP TABLE IF EXISTS ret118_t CASCADE;
...
DROP TABLE IF EXISTS spg_poly145 CASCADE;
CREATE TABLE spg_poly145 (id int, f1 polygon);
INSERT INTO spg_poly145 VALUES
  (1, polygon '((0,0),(0,10),(10,10),(10,0))'),
  (2, polygon '((20,20),(20,30),(30,30),(30,20))'),
  (3, polygon '((40,40),(40,60),(60,60),(60,40))'),
  (4, polygon '((5,30),(5,40),(15,40),(15,30))'),
  (5, polygon '((25,0),(25,8),(35,8),(35,0))');
CREATE INDEX spg_poly145_idx ON spg_poly145 USING spgist (f1);
SET enable_seqscan = off;
SET enable_bitmapscan = off;
SET enable_indexscan = on;
SELECT point(x,x), (SELECT f1 FROM spg_poly145 ORDER BY f1 <-> point(x,x) LIMIT 1)
FROM generate_series(0,50,5) AS g(x);
RESET enable_seqscan;
RESET enable_bitmapscan;
RESET enable_indexscan;
DROP TABLE IF EXISTS spg_poly145 CASCADE;
...
DROP TABLE IF EXISTS spg_poly145_recheck CASCADE;
CREATE TABLE spg_poly145_recheck (id int, f1 polygon);
INSERT INTO spg_poly145_recheck VALUES
  (1, polygon '((0,0),(0,10),(10,10),(10,0))'),
  (2, polygon '((20,20),(20,30),(30,30),(30,20))'),
  (3, polygon '((40,40),(40,60),(60,60),(60,40))'),
  (4, polygon '((5,30),(5,40),(15,40),(15,30))'),
  (5, polygon '((25,0),(25,8),(35,8),(35,0))');
CREATE INDEX spg_poly145_recheck_idx ON spg_poly145_recheck USING spgist (f1);
SET enable_seqscan = off;
SET enable_bitmapscan = off;
SET enable_indexscan = on;
SELECT point(x,x), (SELECT f1 FROM spg_poly145_recheck
                    WHERE f1 && polygon '((-100,-100),(-100,100),(100,100),(100,-100))'
                    ORDER BY f1 <-> point(x,x) LIMIT 1)
FROM generate_series(0,50,5) AS g(x);
RESET enable_seqscan;
RESET enable_bitmapscan;
RESET enable_indexscan;
